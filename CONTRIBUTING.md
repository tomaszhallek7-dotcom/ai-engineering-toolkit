...
**Example:**
```
feat(rag): add support for vector database integration

Implemented support for Pinecone and Weaviate vector databases
to enable RAG pipeline enhancements.
...
### Prerequisites
- Git
- Python 3.8+ (for Python projects) or Node.js 14+ (for JS projects)
...
```bash
# Clone and setup
git clone https://github.com/tomaszhallek7-dotcom/ai-engineering-toolkit.git
